...
class AddTaskActivity : AppCompatActivity() {
    ...
    private fun bindUI() {
        ...
        enterAnimation(binding.item1, binding.item2)
    }
        ...
        if (title.isNotEmpty() && description.isNotEmpty()) {
            ...
            viewModel.apply {
                ...
                if (task != null) {
                    ...
                    updateToDo(tempTask)
                    if (!tempTask.isCompleted) scheduleTask(tempTask)
                    Toast.makeText(
                ...
                when (status) {
                    ...
                    OperationStatus.DONE -> {
                        getTask(task.title, task.description).observe(this@AddTaskActivity) {
                            val intent =
                                Intent(this@AddTaskActivity, TaskReminderService::class.java)
